...
{
	RunTime::ResetMemoryContentAt(0x586B90 + 0x4, &RunTime::Messages::EDIT_KILLFOCUS, 4); // name update //fs
	RunTime::ResetMemoryContentAt(0x586BC0 + 0x4, &RunTime::Messages::COMBOBOX_KILLFOCUS, 4); // veteran update //fs
	RunTime::ResetMemoryContentAt(0x586BD8 + 0x4, &RunTime::Messages::COMBOBOX_KILLFOCUS, 4); // house update //fs
	RunTime::ResetMemoryContentAt(0x586BF0 + 0x4, &RunTime::Messages::EDIT_KILLFOCUS, 4); // priority update //fs
	RunTime::ResetMemoryContentAt(0x586C08 + 0x4, &RunTime::Messages::EDIT_KILLFOCUS, 4); // max update //fs
	RunTime::ResetMemoryContentAt(0x586C20 + 0x4, &RunTime::Messages::COMBOBOX_KILLFOCUS, 4); // techlevel update //fs
	RunTime::ResetMemoryContentAt(0x586C38 + 0x4, &RunTime::Messages::COMBOBOX_KILLFOCUS, 4); // group update //fs
	RunTime::ResetMemoryContentAt(0x586C50 + 0x4, &RunTime::Messages::COMBOBOX_KILLFOCUS, 4); // waypoint update //fs
	RunTime::ResetMemoryContentAt(0x586C68 + 0x4, &RunTime::Messages::COMBOBOX_KILLFOCUS, 4); // script update //fs
	RunTime::ResetMemoryContentAt(0x586C80 + 0x4, &RunTime::Messages::COMBOBOX_KILLFOCUS, 4); // taskforce update //fs
	RunTime::ResetMemoryContentAt(0x586F50 + 0x4, &RunTime::Messages::COMBOBOX_KILLFOCUS, 4); // tag update //fs
	RunTime::ResetMemoryContentAt(0x586F80 + 0x4, &RunTime::Messages::COMBOBOX_KILLFOCUS, 4); // transport waypoint update //fs
	RunTime::ResetMemoryContentAt(0x586FB0 + 0x4, &RunTime::Messages::COMBOBOX_KILLFOCUS, 4); // mind control decision update //fs

	auto addr = &CTeamTypesExt::PreTranslateMessageExt;
	RunTime::ResetMemoryContentAt(0x587088, &addr, 4); //fs
	auto addr2 = &CTeamTypesExt::OnInitDialogExt;
	RunTime::ResetMemoryContentAt(0x5870B4, &addr2, 4); //fs
}
