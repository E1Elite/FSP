...
class ObjectBrowserControlExt : public ObjectBrowserControl
{
    ...
    static std::set<CString> IgnoreSet;
    static std::set<CString> ForceName;
    static std::set<CString> ExtSets[Set_Count];
    static std::map<CString, int> KnownItem;
    static std::map<CString, int> Owners;
